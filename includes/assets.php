...
function palaplast_get_styles() {
	return '.palaplast-matrix{margin-top:10px;margin-bottom:30px}.palaplast-title{font-size:14px;font-weight:500;margin-bottom:10px;color:#222}.palaplast-table-wrap{overflow-x:auto;border:1px solid #e7e9ed;border-radius:10px;background:#fff}.palaplast-table{width:100%;border-collapse:separate;border-spacing:0;font-size:12px;line-height:1.35;color:#1f2937}.palaplast-table th,.palaplast-table td{border-bottom:1px solid #edf1f5;vertical-align:middle;white-space:nowrap}.palaplast-table th{padding:8px}.palaplast-table td{padding:0 8px}.palaplast-table .col-sku{text-align:left}.palaplast-table .col-attr{text-align:center}.palaplast-table th{font-size:12px;font-weight:500;color:#374151;background:#f8fafc;line-height:1.2;letter-spacing:.01em}.palaplast-table th .spec-title{display:block}.palaplast-table th .spec-unit{display:block;font-size:10px;opacity:.5;line-height:1.1;margin-top:1px}.palaplast-table tbody tr{transition:background-color .16s ease}.palaplast-table tbody tr:hover td{background:#f6f9fc}.palaplast-table tr:last-child td{border-bottom:none}.palaplast-table .vt-custom-row td{white-space:normal;text-align:left;padding:0 8px}.palaplast-table .vt-custom-row__content{font-size:11px;line-height:1.4}.palaplast-table .vt-custom-row--info td{background:#eef6ff;color:#1f3a5f}.palaplast-table .vt-custom-row--warning td{background:#fff7e6;color:#7a4b00}.palaplast-table .vt-custom-row--note td{background:#f6f6f6;color:#444}.palaplast-table .palaplast-code-cell{display:inline-flex;align-items:center;justify-content:flex-start;gap:3px}.palaplast-table .palaplast-code-value{font-variant-numeric:tabular-nums}.palaplast-table .palaplast-copy-code{position:relative;display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;border:0;border-radius:4px;background:transparent;color:#7a8699;font-size:10px;line-height:1;cursor:pointer;transition:color .15s ease,background-color .15s ease}.palaplast-table .palaplast-copy-code:hover{color:#374151;background:transparent}.palaplast-table .palaplast-copy-code:focus-visible{outline:2px solid #bfdbfe;outline-offset:1px}.palaplast-table .palaplast-copy-code.is-copied{color:#0f5132;background:#e9f9ee}.palaplast-table .palaplast-copy-code.is-copied::after{content:"Copied";position:absolute;bottom:calc(100% + 4px);left:50%;transform:translateX(-50%);padding:2px 5px;border-radius:4px;background:#111827;color:#fff;font-size:9px;line-height:1;white-space:nowrap;pointer-events:none}.palaplast-table .palaplast-copy-code__icon{font-size:10px}.palaplast-table .palaplast-copy-code__text{position:absolute!important;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}.palaplast-technical-sheet,.palaplast-pricelist{margin:16px 0 0}.palaplast-technical-sheet-button.button,.palaplast-pricelist-button.button{display:inline-flex;align-items:center;gap:6px}.palaplast-pdf-list{margin:0;padding:0;list-style:none;display:flex;flex-direction:column;gap:12px}.palaplast-pdf-list-item{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:14px 16px;border:1px solid #e5e7eb;border-radius:10px;background:#fff;transition:border-color .2s ease,box-shadow .2s ease,transform .2s ease}.palaplast-pdf-list-item:hover{border-color:#d1d5db;box-shadow:0 8px 18px rgba(15,23,42,.08);transform:translateY(-1px)}.palaplast-pdf-list-item__title{font-size:15px;line-height:1.45;font-weight:500;color:#1f2937}.palaplast-pdf-list-item__action{display:inline-flex;align-items:center;justify-content:center;padding:8px 14px;border-radius:999px;background:#111827;color:#fff;font-size:13px;font-weight:600;line-height:1;text-decoration:none;white-space:nowrap;transition:background-color .2s ease,color .2s ease}.palaplast-pdf-list-item__action:hover,.palaplast-pdf-list-item__action:focus{background:#374151;color:#fff}.palaplast-pdf-list-item__action:focus-visible{outline:2px solid #111827;outline-offset:2px}@media (max-width:768px){.palaplast-table{font-size:11px}.palaplast-table th{padding:8px 6px}.palaplast-table td{padding:0 6px}.palaplast-table .vt-custom-row td{padding:0 6px}.palaplast-table .palaplast-copy-code{width:15px;height:15px}.palaplast-pdf-list-item{flex-direction:column;align-items:flex-start}.palaplast-pdf-list-item__action{width:100%;justify-content:center}}';
}
