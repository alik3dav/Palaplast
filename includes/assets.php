...
function palaplast_get_styles() {
	return '.palaplast-matrix{margin-top:10px;margin-bottom:30px}.palaplast-title{font-size:14px;font-weight:500;margin-bottom:10px;color:#222}.palaplast-table-wrap{overflow-x:auto;border:1px solid #e7e9ed;border-radius:10px;background:#fff}.palaplast-table{width:100%;border-collapse:separate;border-spacing:0;font-size:13px;line-height:1.45;color:#1f2937}.palaplast-table th,.palaplast-table td{border-bottom:1px solid #edf1f5;padding:8px 12px;vertical-align:middle;white-space:nowrap}.palaplast-table .col-sku{text-align:left}.palaplast-table .col-attr{text-align:center}.palaplast-table th{font-size:12px;font-weight:500;color:#374151;background:#f8fafc;line-height:1.2;letter-spacing:.01em}.palaplast-table th .spec-title{display:block}.palaplast-table th .spec-unit{display:block;font-size:10px;opacity:.5;line-height:1.1;margin-top:2px}.palaplast-table tbody tr{transition:background-color .18s ease}.palaplast-table tbody tr:hover td{background:#f8fbff}.palaplast-table tr:last-child td{border-bottom:none}.palaplast-table .vt-custom-row td{white-space:normal;text-align:left;padding:8px 12px}.palaplast-table .vt-custom-row__content{font-size:12px;line-height:1.45}.palaplast-table .vt-custom-row--info td{background:#eef6ff;color:#1f3a5f}.palaplast-table .vt-custom-row--warning td{background:#fff7e6;color:#7a4b00}.palaplast-table .vt-custom-row--note td{background:#f6f6f6;color:#444}.palaplast-code-cell{display:flex;align-items:center;justify-content:space-between;gap:8px}.palaplast-code-value{font-variant-numeric:tabular-nums}.palaplast-copy-code{display:inline-flex;align-items:center;gap:4px;padding:2px 6px;border:1px solid transparent;border-radius:6px;background:transparent;color:#6b7280;font-size:11px;line-height:1;cursor:pointer;transition:color .15s ease,background-color .15s ease,border-color .15s ease}.palaplast-copy-code:hover{color:#1f2937;background:#f1f5f9;border-color:#dbe3ec}.palaplast-copy-code:focus-visible{outline:2px solid #bfdbfe;outline-offset:1px}.palaplast-copy-code.is-copied{color:#0f5132;background:#e9f9ee;border-color:#c5ecd4}.palaplast-copy-code__icon{font-size:12px}.palaplast-technical-sheet,.palaplast-pricelist{margin:16px 0 0}.palaplast-technical-sheet-button.button,.palaplast-pricelist-button.button{display:inline-flex;align-items:center;gap:6px}.palaplast-pdf-list{margin:0;padding:0;list-style:none;display:flex;flex-direction:column;gap:12px}.palaplast-pdf-list-item{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:14px 16px;border:1px solid #e5e7eb;border-radius:10px;background:#fff;transition:border-color .2s ease,box-shadow .2s ease,transform .2s ease}.palaplast-pdf-list-item:hover{border-color:#d1d5db;box-shadow:0 8px 18px rgba(15,23,42,.08);transform:translateY(-1px)}.palaplast-pdf-list-item__title{font-size:15px;line-height:1.45;font-weight:500;color:#1f2937}.palaplast-pdf-list-item__action{display:inline-flex;align-items:center;justify-content:center;padding:8px 14px;border-radius:999px;background:#111827;color:#fff;font-size:13px;font-weight:600;line-height:1;text-decoration:none;white-space:nowrap;transition:background-color .2s ease,color .2s ease}.palaplast-pdf-list-item__action:hover,.palaplast-pdf-list-item__action:focus{background:#374151;color:#fff}.palaplast-pdf-list-item__action:focus-visible{outline:2px solid #111827;outline-offset:2px}@media (max-width:768px){.palaplast-table{font-size:12px}.palaplast-table th,.palaplast-table td{padding:6px 8px}.palaplast-table .vt-custom-row td{padding:6px 8px}.palaplast-copy-code__text{display:none}.palaplast-pdf-list-item{flex-direction:column;align-items:flex-start}.palaplast-pdf-list-item__action{width:100%;justify-content:center}}';
}
